...
def integrand2(Log_rMid2, M, Mr, Log_rin2, f):
    ...
    Fv = Flux(f, M, Mr, Log_rMid2, Log_rin2)
...
def Lf2(f, M, Mr, Log_rin2, Log_rout2):
...
def L2(M, Mr, Log_rin2, Log_rout, Fstart, Fstop):
    ...
    result, _ = scipy.integrate.quad(Lf, Fstart, Fstop, args=(M, Mr, Log_rin2, Log_rout))
    return result
...
print(f"Total Luminosity for no spin: {total_L:.3e} W")
